 ...
 *
 */
double GetElevation(struct site location, const struct dem dem[], 
   int mpi, double ppd)
{
...
void ReadPath(struct site source, struct site destination, path_t *path, 
   const struct dem dem[],int mpi, double ppd)
{
 ...
 * pointed to. */
int OrMask(double lat, double lon, int value, struct dem dem[],
   int mpi, double ppd)
{
...
int GetMask(double lat, double lon, struct dem dem[],int mpi, double ppd)
{
...
int PutSignal(double lat, double lon, unsigned char signal, struct dem dem[],
   int mpi, double ppd)
{
 ...
 */
unsigned char GetSignal(double lat, double lon, struct dem dem[], 
   int mpi, double ppd)
{
...
/* Lines, text, markings, and coverage areas are stored in a
   ...
   area pointed to. */
int PutMask(double lat, double lon, int value, struct dem dem[], int mpi, 
   double ppd)
{
...
void PlotLRPath(struct site source, struct site destination, 
   unsigned char mask_value, struct LR LR, struct dem dem[], int mpi, double ppd,
